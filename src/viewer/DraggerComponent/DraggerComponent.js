...
export class DraggerComponent extends Component {
  ...
  onIssueEdit = () => this.activateDraggerByName("Issue");
        ...
        >
          ...
          >
            ...
            <button
              ...
              className={
                "btn btn-outline-secondary d-flex flex-column " +
                (activeDraggerName === "MeasureLine" ? "active-dragger" : "")
              }
            >
            ...
            <button
              disabled={!isEnable}
              type="button"
              onClick={this.onIssueEdit}
              className={
                "btn btn-outline-secondary d-flex flex-column " +
                (activeDraggerName === "Issue" ? "active-dragger" : "")
              }
            >
              <img src="icons/issue.svg" alt="" />
              Issue
            </button>
            {is3D ? (
              <button
