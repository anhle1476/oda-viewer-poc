  ...
  return (
      ...
      onFinish={(values) => {
        ...
        project
          ...
          .then(() => {
            ...
            fetch(project.avatarUrl).catch(() => {}); // <- to refresh image in the browser cache
          })
          .catch((e) => {
            console.error("Cannot update preview.", e.message);
    ...
    >
      <Row gutter={[16, 16]}>
        ...
        <Col lg={16} xs={24}>
          <Form.Item name="avatarUrl" valuePropName="src">
            <Image
